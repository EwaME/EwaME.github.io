...
function init() {
  ...
  function drawText() {
    ...
    ctx.fillText("Te amo mi Belencita!", width / 2, height / 2.2 + 400);
  }
...
function continueMusic() {
  ...
  // Evento para guardar estado de la música
  ...
  }, 1000); // Guarda el tiempo cada segundo

  // Permitir inicio manual si no está reproduciendo
